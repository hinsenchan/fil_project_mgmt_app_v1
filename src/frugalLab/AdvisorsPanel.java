...
public class AdvisorsPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        advisorNameLabel.setBackground(new java.awt.Color(143, 19, 21));
        advisorNameLabel.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
        advisorNameLabel.setForeground(java.awt.Color.white);
        advisorNameLabel.setText("Advisor Name:");
        advisorNameLabel.setOpaque(true);
        propertyLayoutPanel.add(advisorNameLabel);

        advisorNameTextField.setPreferredSize(new java.awt.Dimension(180, 27));
        propertyLayoutPanel.add(advisorNameTextField);
    ...
    private javax.swing.JTextField advisorNameTextField;
