...
public class PartnersPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        partnerNameLabel.setBackground(new java.awt.Color(143, 19, 21));
        partnerNameLabel.setFont(new java.awt.Font("Ubuntu", 1, 15)); // NOI18N
        partnerNameLabel.setForeground(java.awt.Color.white);
        partnerNameLabel.setText("Partner Name:");
        partnerNameLabel.setOpaque(true);
        propertyLayoutPanel.add(partnerNameLabel);

        partnerNameTextField.setPreferredSize(new java.awt.Dimension(180, 27));
        propertyLayoutPanel.add(partnerNameTextField);
