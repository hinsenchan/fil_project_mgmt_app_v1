...
public class StudentsTableController implements ListSelectionListener, TableModelListener{
	...
	studentsTableModel = new StudentsTableModel(); // create new table model
    ...
    public void tableChanged(TableModelEvent e)
    {
	    ...
	    studentsTableModel = new StudentsTableModel(studentsTableModel.getList(), studentsTableModel.getEntityManager());
